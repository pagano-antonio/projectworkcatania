...
<div class="container">
	<div class="screen">
		<div class="screen__content">
			...
			<form action="${pageContext.request.contextPath}/SkillController/searchByTitle" method="post" class="login">
			
			<div class="login__field">
					<i class="login__icon fas fa-briefcase"></i>
					<input type="text" class="login__input" placeholder="Skill Title" id="title" name="title" required>
				</div>
