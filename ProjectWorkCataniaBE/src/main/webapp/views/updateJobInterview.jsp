...
<div class="container">
	<div class="screen">
		...
		<form action="${pageContext.request.contextPath}/JobInterviewController/addJobInterview" method="post" class="login">
			<c:set var="jobInterview" value="${JobInterviewFound}"/>
				...
				<div class="login__field">
					...
					<input type="number" class="login__input" placeholder="Outcome" id="outcome" name="outcome" value="${jobInterview.outcome}">
				</div>
				<div class="login__field">
					<i class="login__icon fas fa-user"></i>
