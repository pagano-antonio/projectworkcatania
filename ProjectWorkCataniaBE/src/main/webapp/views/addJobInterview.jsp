...
.login__submit {
	background: #fff;
	font-size: 14px;
	margin-top: 18px; /*per portare su o giù il bottono*/
	padding: 16px 20px;
	border-radius: 26px;
		...
		<div class="screen__content">
			...
			<form action="${pageContext.request.contextPath}/addJobOffer" method="post" class="login">
				...
				<div class="login__field">
					...
					<input type="date" class="login__input" placeholder="Date" id="date" name="date">
				</div>
				<div class="login__field">
					<i class="login__icon fas fa-user"></i>
					<input type="number" class="login__input" placeholder="Outcome" id="outcome" name="outcome">
				</div>
				<div class="login__field">
					<i class="login__icon fas fa-clipboard"></i>
					<input type="text" class="login__input" placeholder="Notes" id="notes" name="notes">
				</div>
				...
				<div class="login__field">
  				...
  				<option value="">State Job Interview</option>
  				<c:forEach var="state" items="${stateJob}">
				...
				<button class="button login__submit">
					<span class="button__text">Add Job Interview</span>
