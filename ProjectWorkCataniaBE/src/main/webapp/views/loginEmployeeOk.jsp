...
<th>IdCandidate</th>
<th>Date</th>
<th>idStateJobInterview</th>
<th>Outcome</th>
<th>Notes</th>
</tr>

<c:forEach var="jobInterview" items="${jobInterviewsFound}">
<tr>
<td>${jobInterview.idCandidate}</td>
<td>${jobInterview.date}</td>
<td>${jobInterview.idStateJobInterview}</td>
<td>${jobInterview.outcome}</td>
<td>${jobInterview.notes}</td>


 		<td>
	   	<form action="${pageContext.request.contextPath}/RicercaPerId" method="post">
    	<input type="hidden" name="idPersona" value="${per.getIdPersona()}">
    	<button type="submit">Aggiorna</button>
		</form>
		
		<form action="${pageContext.request.contextPath}/Elimina" method="post">
    	<input type="hidden" name="idPersona" value="${per.getIdPersona()}">
