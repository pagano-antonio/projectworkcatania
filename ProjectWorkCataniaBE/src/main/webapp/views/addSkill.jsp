...
<div class="container">
	<div class="screen">
		<div class="screen__content">
			...
			<form action="${pageContext.request.contextPath}/SkillController/addSkill" method="post" class="login">
			
				<div class="login__field">
					<i class="login__icon fas fa-user"></i>
					<input type="text" class="login__input" placeholder="Title" id="title" name="title" >
				</div>
				<div class="login__field">
				...
				<button class="button login__submit">
					<span class="button__text">Add Skill to Database</span>
